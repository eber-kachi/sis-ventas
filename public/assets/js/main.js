$(document).ready(function () {
    ...
    // Creating map object
    if (document.getElementById('txtLat').value == "" && document.getElementById('txtLng').value == "" ) {
        var map = new google.maps.Map(document.getElementById('map_canvas'), {
            zoom: 12,
            center: new google.maps.LatLng(-17.415216, -66.162621),
            mapTypeId: google.maps.MapTypeId.ROADMAP
        });

        // creates a draggable marker to the given coords
        var vMarker = new google.maps.Marker({
            position: new google.maps.LatLng(-17.415216, -66.162621),
            draggable: true
        });
